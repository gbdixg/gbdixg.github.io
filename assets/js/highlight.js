...
;hljs.registerLanguage("typescript",e)})();/*! `wasm` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("csharp",e)})();/*! `bash` grammar compiled for Highlight.js 11.7.0 */
